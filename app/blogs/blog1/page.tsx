    ...
    <>
      ...
      <article className={styles.blogContainer}>
          ...
          <section className={styles.introSection}>
            ...
            <p>It's not just the story of scienceâ€”it's the story of dreamers, warriors, and a nation rising against odds. And yes, India has been part of that story for much longer than most people realize.</p>
            <p>Let's take off and explore the amazing journey of rocketsâ€”and how India carved out its space in the stars.</p>
          </section>

          <section className={styles.contentSection}>
            <h2>Chapter 1: The Ancient Spark â€“ When Imagination Took Flight</h2>
            ...
            <p>Now, sure, they were part of mythologyâ€”but doesn't it show how deeply we were thinking about space and flight thousands of years ago? It's like our ancestors were dreaming of missiles and drones way before anyone else!</p>
          </section>

          <section className={styles.contentSection}>
            <h2>Chapter 2: Tipu Sultan â€“ The Real-Life Rocket Warrior</h2>
            <p>Fast forward to the 1700s, and we meet Tipu Sultan, the ruler of Mysore. This man didn't just fight the Britishâ€”he freaked them out with rockets! Mysorean Rockets were no ordinary firecrackers. They had iron casings, carried explosive payloads, and could travel up to 2 km.</p>  
            <p>Tipu's army would launch hundreds at once, turning the battlefield into a chaotic fireworks show (except... deadlier). And guess what? These rockets were so effective that the British took them back home and used the idea to create their own: the Congreve rockets, which they then used in wars across Europe. So yeahâ€”India inspired European rocketry!</p>
          </section>

          <section className={styles.contentSection}>
            <h2>Chapter 3: A Nation Reborn â€“ From Bullock Carts to Launch Pads</h2>
            <p>After independence in 1947, India had a dreamâ€”not just to grow, but to reach for the stars. Enter the space nerds. And at the center of it all was Dr. Vikram Sarabhai, the father of the Indian space program.</p>
          ...
          <section className={styles.timelineSection}>
            <h2>Chapter 4: ISRO â€“ India's Ticket to Space</h2>
          ...
          <section className={styles.contentSection}>
            <h2>Chapter 5: The Future is Now â€“ What's Next for Indian Rocketry?</h2>
          ...
          <section className={styles.conclusionSection}>
            ...
            <p>India's rocket journey isn't just about tech and science. It's about people who refused to give up. From Tipu Sultan's explosive innovations to scientists working with bicycles and bullock carts, and now to Moon landings and Mars orbitsâ€”India's space journey is a masterclass in jugaad, vision, and pure passion.</p>
